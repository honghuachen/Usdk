...
public class EncryptUtils {
    public static String encryptDES(String encryptString, String encryptKey) throws Exception {
        ...
        //创建�?个DESKeySpec对象，使�?8个字节的key作为DES密钥的内�?
        ...
        //使用iv中的字节作为iv来构造一个iv ParameterSpec对象。复制该缓冲区的内容来防止后续修�?
        IvParameterSpec iv = new IvParameterSpec(encryptKey.getBytes());
        //用密钥和�?组算法参数初始化�? Cipher；Cipher：加密�?�解密�?�密钥包装或密钥解包，具体取决于 opmode 的�?��??
