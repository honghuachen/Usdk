...
public class ProxyBase extends UsdkBase implements IProxyBase {
	protected PlatformCallbackWrapper platformCallBackWrapper = null;
	protected List<String> mTokens = new ArrayList<String>();
	
	public ProxyBase() {
		platformCallBackWrapper = new PlatformCallbackWrapper();
	}
	...
	public void setSdkCallBackReceiver(String receiverName) {
		platformCallBackWrapper.setSdkCallBackReceiver(receiverName);
	}
