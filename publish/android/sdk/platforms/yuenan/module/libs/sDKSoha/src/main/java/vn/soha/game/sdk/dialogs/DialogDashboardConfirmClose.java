...
public class DialogDashboardConfirmClose {
	...
	public DialogDashboardConfirmClose(Activity activity,InteractConfirmCloseDashBoard interactice) {
	...
	public void initDialog() {
		...
		mDialog.setContentView(R.layout.dialog_dashboard_confirm_close);
