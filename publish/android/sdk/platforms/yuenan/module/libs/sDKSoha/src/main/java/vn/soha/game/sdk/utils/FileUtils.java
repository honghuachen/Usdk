...
public class FileUtils {
	...
	public static String folderSystem = Environment.getExternalStorageDirectory().getPath();
	...
	public static String getFileTime(File f) {
		...
		String ftime =  formatter.format(new Date(f.lastModified())); 
		return ftime;
	}
	...
	public static void vRenameFile(String oldFilePath, String newFilePath){
	...
	public static boolean bDeleteFolder(File folderPath) {
	...
	public static boolean bDeleteFile(File filepath) {
		boolean isOK = true;
		if (filepath.exists()) {
			filepath.delete();
		} else {
