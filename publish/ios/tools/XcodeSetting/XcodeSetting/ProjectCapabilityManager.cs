...
#endif
{
    ...
    public class ProjectCapabilityManager {
        ...
        /// <summary>
        /// Adds Sign In With Apple capability to the project.
        /// </summary>
        ...
        /// <summary>
        /// Adds Access WiFi Information capability to the project.
        /// </summary>
        ...
        /// <summary>
        /// Adds Auto Fill Credential Provider capability to the project.
        /// </summary>
        public void AddAutoFillCredentialProvider () {
            GetOrCreateEntitlementDoc ().root[AutoFillCredentialProviderEntitlements.Key] = new PlistElementBoolean (true);
            project.AddCapability (m_TargetGuid, PBXCapabilityType.AccessWiFiInformation, m_EntitlementFilePath);
        }
    ...
    internal class AutoFillCredentialProviderEntitlements {
        // value is bool true.
        internal static readonly string Key = "com.apple.developer.authentication-services.autofill-credential-provider";
    }
}